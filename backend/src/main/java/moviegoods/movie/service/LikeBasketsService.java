...
=======
    ...
    public Boolean deleteLike(Long like_basket_id, Long user_id) {
        Like_Basket like_basket = likeBasketRepository.findById(like_basket_id).orElseThrow(() -> new IllegalArgumentException("해당 좋아요 내역이 없습니다. like_basket_id = {}"+ like_basket_id));
